...
const GUIDE_DATA = {
  stage: {
    title: "투여 Stage",
    question: "다음 중 자신에게 해당하는 투여 Q. stage를 선택해주세요",
    options: [
      { id: "stage1", label: "Stage 1 약물 증량기", description: "현재 투여 중이며 시작 용량 또는 증량 과정에 있음" },
      { id: "stage2", label: "Stage 2 약물 용량 유지기", description: "현재 투여 중이며 유지 용량에 도달했거나 의료진이 현 용량을 유지하기로 정함" },
      { id: "stage3", label: "Stage3 투여 중단 및 완료기", description: "투여를 중단했거나 다음 투여가 예정되어 있지 않음" },
    ],
    recommendations: {
      stage1: { title: "Stage 1", points: ["위장관 증상 완화와 탈수 영양부족 방지가 가장 핵심 목표입니다.", "특히 투여 시작과 증량 시기에 오심 구토 설사 변비 복통 등이 흔하며 시간이 지나면 감소하는 경향이 있습니다.", "한 끼를 억지로 크게 먹기보다 소량으로 규칙적으로 섭취합니다.", "위장관 증상이 심하면 기름진 음식 튀김 매우 큰 식사 고지방 메뉴를 우선 제외하고 증상 초기에는 고섬유질 식품을 한 번에 많이 먹지 않아야 합니다.", "탈수 위험이 있으면 수분을 최대한 확보해야 합니다.", "먹을 수 있는 양이 적으므로 단백질 식품을 챙겨 먹어야 합니다."] },
      stage2: { title: "Stage 2", points: ["충분한 영양소 섭취와 근육 골량 보전 지속 가능한 식사 패턴을 수립하는 것이 가장 핵심 목표입니다.", "유지기에 들어가면 위장관 증상은 평균적으로 감소하지만 식욕 저하와 낮은 섭취량은 계속될 수 있습니다.", "낮은 에너지 섭취가 지속되면 철 칼슘 마그네슘 아연 비타민 A·D·E·K·B1·B12·C 부족 위험이 커질 수 있습니다.", "근육량 보전을 위해 단백질 식품을 지속적으로 챙겨 먹어야 합니다 다만 단백질 식품만 늘리는 것으로 근육 손실을 막을 수는 없으므로 근육 운동도 병행해야 합니다."] },
      stage3: { title: "Stage 3", points: ["식욕 섭취량의 반등에 대비하고 체중 재증가를 줄일 수 있는 식사 습관을 유지하는 것이 핵심 목표입니다.", "허기 음식 생각 간식 욕구가 다시 커질 수 있으므로 식사량을 과거처럼 무조건 줄이기보다 규칙적인 식사 시간 아침 식사 계획된 간식 습관을 유지해야 합니다.", "정제 탄수화물 당 음료 초가공 간식으로의 회귀 위험이 있으므로 지나친 금식이나 완전 제한보다는 소량 허용 전략을 수립하는 것이 좋습니다.", "Stage 1의 낮은 섭취량을 그대로 목표로 두지 말고 현재 체중 활동량 체중 변화에 따라 재산정해야 합니다."] },
    },
  },
  sideEffects: {
    title: "부작용",
    question: "아래 부작용 권고사항 중 자신에게 해당하는 항목을 선택해주세요",
    options: [
      { id: "nausea", label: "오심", description: "속이 울렁거리거나 토할 것 같은 느낌이 있나요 음식 냄새만으로 메스꺼운 경우도 포함됩니다." },
      { id: "diarrhea", label: "설사", description: "평소보다 묽거나 물 같은 변을 자주 보나요 하루 3회 이상이거나 평소보다 뚜렷하게 잦은 경우를 포함합니다." },
      { id: "vomiting", label: "구토", description: "음식물이나 물을 실제로 토했나요?" },
      { id: "constipation", label: "변비", description: "일주일에 배변이 3회 미만이거나 변이 딱딱하고 건조해 배변이 힘드나요 배변 뒤에도 덜 본 느낌이 남는 경우를 포함합니다." },
      ...
      { id: "abdominal", label: "복통 소화불량 복부 팽창 트림 가스 참", description: "식후 더부룩함 잦은 트림 복부 팽만감 또는 지나치게 가스가 차는 등 불편함이 있나요?" },
    ...
    recommendations: {
      nausea: ["식사를 완전히 거르기보다 한 번에 먹는 양을 줄여보세요 아침에 소량으로 시작하고 작은 식사를 규칙적으로 나누어 드시는 방법이 도움이 될 수 있습니다.", "증상이 심한 며칠 동안은 튀김 같은 기름진 고지방 음식과 고식이섬유 식품은 적게 섭취하고 담백하고 부드러운 식사를 선택하세요.", "수분은 한 번에 많이 마시기보다 조금씩 자주 보충하세요."],
      diarrhea: ["설사가 있다면 탈수의 위험이 있으므로 수분과 전해질 보충을 우선하세요 물 맑은 국물 등 본인에게 잘 맞는 음료를 조금씩 자주 드세요.", "한 번에 많은 양을 먹는 것이나 기름진 식사는 피하고 증상이 가라앉을 때까지 소량의 저지방 식사를 선택하세요."],
      vomiting: ["구토가 있을 때는 한 번에 많은 양을 먹지 마세요.", "탈수의 위험이 있으므로 수분 섭취가 중요해요 물이나 이온 음료를 소량씩 자주 마시세요.", "구토가 가라앉으면 소량의 담백하고 저지방인 식사부터 여러 번에 나누어 섭취해야 하세요 특히 큰 식사는 구토를 유발할 수 있으므로 배가 부르기 전 멈추기를 실천하세요."],
      constipation: ["변비가 있다면 수분 섭취를 먼저 확인하세요.", "채소 통곡물 콩류 등 식이섬유가 있는 식품을 갑자기 많이 늘리기보다 본인에게 맞는 양부터 천천히 늘려보세요.", "단백질은 체중 감량 중 중요한 영양소이지만 고단백 고지방 식품을 과하게 먹었을 때 변비가 더 심해지는 분도 있습니다 이 경우에는 단백질 식품을 완전히 빼기보다는 저지방 수분 있는 조리법으로 바꾸어 섬유소와 수분을 함께 보충하세요."],
      pancreatitis: ["체중이 급격하게 감소하면 담즙으로 배출되는 콜레스테롤이 증가해 담석이 발생해 췌장염으로 이어질 수 있으므로 과도한 장시간 금식이나 극단적인 저열량 식단은 피해야 해요.", "오른쪽 윗배 통증이 지속되면 즉시 정확한 진단과 조기 치료가 중요하니 의료진에게 진료받으세요."],
      gallstone: ["체중이 급격하게 감소하면 담즙으로 배출되는 콜레스테롤이 증가해 담석이 발생하므로 과도한 장시간 금식이나 극단적인 저열량 식단은 피해야 해요.", "통증이 몇 시간 지속되면 즉시 정확한 진단과 조기 치료가 중요하니 의료진에게 진료받으세요."],
      abdominal: ["기름진 음식과 큰 식사를 피하세요.", "늦은 시간의 과식과 음주는 불편함을 악화시킬 수 있으므로 줄이는 것이 좋습니다 증상이 있는 동안에는 저지방 소량 부드러운 식사를 우선 선택하세요."],
      headache: ["두통이 지속되거나 심해지면 단순 부작용으로 넘기지 말고 영양 상태와 다른 원인을 함께 확인해야 합니다.", "물을 조금씩 자주 마시고 오랜 시간 공복이 되지 않도록 소량의 규칙적인 식사를 유지하세요.", "지나치게 적은 식사량이 원인일 수 있으니 열량만 낮추기보다 단백질 과일 채소 유제품 또는 대체식품 등 영양밀도가 높은 식품을 우선 선택하세요."],
      hypoglycemia: ["설포닐우레아 또는 인슐린과 병용하여 이 약을 투여하는 환자는 저혈당 위험이 증가할 수 있습니다 이 약으로 치료 시작할 때 설포닐우레아 또는 인슐린을 감량하여 저혈당 위험을 낮출 수 있으니 의사와 상담하세요.", "혈당을 높이려면 빠르게 흡수되는 탄수화물 15g을 섭취하세요 반면 섬유질 지방 단백질 함량이 높은 음식은 체내에서 소화되는 속도를 늦춥니다 초콜릿이나 땅콩버터가 들어간 음식은 저혈당을 치료하는 데 좋은 선택이 아닙니다 주스 또는 일반 탄산음료 설탕 또는 옥수수 시럽 1큰술 딱딱한 사탕이나 젤리빈 등으로 혈당을 올리세요."],
      hairLoss: ["GLP-1 치료 중 급격한 열량 감소로 인한 큰 체중 감소는 철 아연 비타민 A·D·E·K·B군·C 등의 부족 위험을 높일 수 있고 탈모는 영양 결핍 신호일 수 있습니다.", "탈모가 있다면 식사량을 더 줄이기보다 적정 열량과 단백질을 먼저 확보하세요.", "적은 양을 먹더라도 단백질 식품 채소 과일 유제품 또는 강화 대체식품 등 영양밀도가 높은 식품을 골고루 선택하는 것이 중요합니다.", "탈모만을 이유로 비오틴 철분 아연 등을 무작정 챙기기보다 영양제 필요 여부는 혈액검사와 의료진 상담을 거친 후 결정하세요."],
    },
  },
  weight: {
    title: "체중 변화",
    question: "최근 체중 변화는 어떤가요?",
    options: [{ id: "rapidLoss", label: "체중이 너무 빠르게 줄고 있어요" }, { id: "steadyLoss", label: "천천히 꾸준히 줄고 있어요" }, { id: "plateau", label: "체중 변화가 거의 없어요" }, { id: "regain", label: "체중이 다시 늘고 있어요" }],
    recommendations: {
      rapidLoss: { title: "급격한 체중 감소", points: ["탈수와 영양 부족을 막기 위해 섭취량과 수분 섭취를 점검하세요.", "과도한 장시간 금식이나 극단적인 저열량 식단은 피하고, 단백질과 영양밀도 높은 식품을 챙기세요.", "짧은 기간에 큰 폭의 변화가 이어지면 의료진과 상의하세요."] },
      steadyLoss: { title: "꾸준한 체중 감소", points: ["현재의 규칙적인 식사와 수분 섭취 패턴을 유지하세요.", "체중만 낮추기보다 단백질 섭취와 근육 운동을 함께 챙겨 근육량을 보전하세요."] },
      plateau: { title: "체중 정체", points: ["현재 체중, 활동량, 식사량을 다시 확인하고 섭취 목표를 재산정하세요.", "지나친 제한보다 지속 가능한 식사 패턴과 근육 운동을 우선하세요."] },
      regain: { title: "체중 재증가", points: ["규칙적인 식사 시간과 계획된 간식 습관을 회복하세요.", "당 음료, 정제 탄수화물, 초가공 간식의 섭취 빈도를 점검하세요.", "지나친 금식으로 보상성 폭식이 생기지 않도록 소량 허용 전략을 세우세요."] },
    },
  },
  appetite: {
    title: "식욕",
    question: "오늘 식욕과 식사 컨디션은 어떤가요?",
    options: [{ id: "none", label: "입맛이 거의 없고 음식을 먹는 것이 부담스러워요" }, { id: "moderate", label: "식욕이 적당하고 소식으로도 만족스럽게 식사할 수 있어요" }, { id: "high", label: "배고픔이 심하게 몰려오거나 단 음식 야식 간식 생각이 계속 맴돌아요" }],
    recommendations: {
      none: { title: "입맛이 거의 없을 때", points: ["한 번에 평균 식사량을 먹으려 하지 말고 3~4시간 간격으로 소량씩 나누어 드세요.", "미온수의 물을 조금씩 자주 마시고, 고단백 쉐이크·스무디·맑은 단백질 수프·계란찜 등 부드러운 단백질 연식과 유동식을 활용하세요."] },
      moderate: { title: "적당한 식욕", points: ["조기 포만감이 느껴질 수 있으므로 생선, 달걀, 콩류, 유제품, 살코기 등 단백질을 먼저 챙기세요.", "과일, 채소, 통곡물, 콩류, 견과류 등 영양밀도 높은 식품을 골고루 선택하세요.", "천천히 소량으로 먹고 포만감이 느껴지면 다음 식사로 넘기세요."] },
      high: { title: "허기와 음식 생각이 많을 때", points: ["물 한 컵을 천천히 마시고 15분 기다리며 진짜 허기인지 확인하세요.", "과자나 배달음식 대신 삶은 달걀, 그릭요거트, 풋콩, 견과류 한 줌, 방울토마토와 오이 등 고단백·고식이섬유 간식을 먼저 선택하세요.", "장시간 공복을 피하고 끼니를 거르지 않으며 규칙적으로 적정량을 유지하세요."] },
    },
  },
};
  ...
  return (
    <div style={{ background: C.bg, color: C.ink, minHeight: "100vh" }} className="w-full">
      ...
      <div className="max-w-2xl mx-auto px-5 py-12 md:py-16 font-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {Object.entries(GUIDE_DATA).map(([category, guide], index) => (
                <button key={category} type="button" onClick={() => openGuide(category)} className="rounded-2xl p-5 flex items-center justify-between text-left hover:shadow-md transition-all" style={{ background: C.card, border: `1px solid ${index % 2 ? C.apricot : C.sagePale}` }}>
                  <span><strong className="block text-sm">{guide.title}</strong><small className="block mt-1" style={{ color: C.ink60 }}>{guide.options.length}가지 상태 중 선택</small></span>
        ...
        {flowType === "guide" && guideCategory && !guideAnswer && (
          <div className="flex flex-col gap-6">
